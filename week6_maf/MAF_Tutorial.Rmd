...
maf_object <- read.maf(maf = "C:/Users/kenne/OneDrive/Desktop/QBIO490/qbio_490_kenneth/analysis_data/brca_maf_data.csv_maftools.maf", 
...
#ggsave("C:/Users/kenne/OneDrive/Desktop/QBIO490/qbio_490_kenneth/week6_maf/oncoplot1.png")

# 1. Open jpeg file
jpeg("C:/Users/kenne/OneDrive/Desktop/QBIO490/qbio_490_kenneth/week6_maf/oncoplot1.jpg")
# 2. Create the oncoplot
oncoplot(maf = maf_object,
         top = 20) 
# 3. Close the file
dev.off()
#Nicole is fixing the error, she says to just submit it and it’s fine
```
...
The TP53 gene is used to synthesize the p53 protein, which regulates cell division by limiting cell growth and division. A mutation in this gene would likely cause cell growth and division to continue without limitations, caushing cancerous growth.
...
```{r}
oncoplot(maf = maf_object,
         genes = c("TP53", "TTN", "GATA3", "KMT2C", "HMCN1"))
#Nicole is fixing the error, she says to just submit it and it’s fine
```
...
1. Are certain types of genetic mutations more likely to lead to cancerous outcomes?
2. Do mutations in multiple genes amplify cancer growth?
...
Yes, there are some clusterings for young patients.
...
```{r}
old_mask = ifelse((maf_object@clinical.data$age_at_initial_pathologic_diagnosis >= 50), TRUE, FALSE)
...
ggsave("C:/Users/kenne/OneDrive/Desktop/QBIO490/qbio_490_kenneth/week6_maf/coOncoplot1.png")
#Nicole is fixing the error, she says to just submit it and it’s fine
```
...
Hypothesized Reason: TTN mutations are associated with late replication times (https://www.nature.com/articles/s41525-019-0107-6). Thus, older patients are more likely to have a mutation in TTN because their older age means that more gene replications occurred throughout their lifetime that could've caused this mutation.
...
ggsave("C:/Users/kenne/OneDrive/Desktop/QBIO490/qbio_490_kenneth/week6_maf/lollipop1.png")
```

Does TP53 have any domains? If so, list them and provide a brief description of their functions.
P53_TAD: a transactivation domain that allows transcription coregulators to bind
P53: transcribes the sequence that is later converted to p53 protein
P53_tetramer: allows for oligomerization of p53
...
Amino acid ~#175 has 19 mutations
...
lollipopPlot2(m1 = young_maf, 
              m2 = old_maf, 
              m1_name = "Age < 50 years",
              m2_name = "Age >= 50 years",
...
The TP53 gene appears to be more mutated for older patients than younger patients, especially near the middle/end of the P53 domain and the P53_tetramer domain. This suggests that the P53 domain and P53_tetramer dimains may be essential to inhibiting/promoting cancer growth. Missense mutations appear to be the most common for both groups, although the older patient group appears to have a higher proportion of missenses than the younger patient group.
...
TP53 is a gene that corresponds with p53 proteins, which regulate cell growth and division. Thus, a mutated version of this gene would be expected to cause worse survival outcomes because cell growth and division would continue unhindered if the gene were to be mutated.

What can you conclude from your plot?
Although it visually appears that the mutated gene leads to worse survival outcomes, the p value of 0.0859 indicates that there is no statistically significant decrease in survival as a result of the mutated TP53 gene.

Is this what you would expect according to the literature? Why or why not?
No. The literature seems to have a common consensus that the mutated TP53 gene would lead to worseoutcomes since cell growth and division is uncontrolled. The graph visually supports this idea, but the lack of statistical significance means that we cannot infer this conclusion from the graph.
