...
Look up "early onset breast cancer" in Google Scholar and pick a paper to skim.
    1. Link to paper: https://www.nature.com/articles/bjc1997223
    2. What is one thing you learned from this paper: The paper suggests that age doesn't affect one's chances of cancer survival, although certain age groups are more inclined to have certain types of cancers.
...
# write code here
sum(age_mask)
#This represents the number of patients in the data that are younger than 50 years old.
```
...
Survival decreases over time for both groups.
The young group generally has a higher survival probability than the old group.
...
write.csv(clinical, "C:/Users/kenne/OneDrive/Desktop/QBIO490/qbio_490_kenneth/analysis_data/brca_clinical_data.csv", row.names = FALSE)
```
